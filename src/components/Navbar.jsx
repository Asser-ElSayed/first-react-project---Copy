...
<nav className="flex items-center justify-between flex-wrap bg-black p-6">
  <div className="flex items-center flex-shrink-0 text-white mr-6">
    ...
    <span className="font-semibold text-xl tracking-tight">Tickets Site</span>
  </div>
  ...
  <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    ...
    <a href="http://localhost:5173" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
      ...
      <a href="http://localhost:5173/Faq" className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white">
        FAQ
      </a>
    </div>
    <div>
