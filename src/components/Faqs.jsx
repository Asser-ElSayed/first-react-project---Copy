...
function Faqs() {
    const[ShowAnswer,ShowAnswerFn]=useState(false);
    const [ShowAnswerSecond,ShowAnswerFnSecond]=useState(false);
    const [ShowAnswerThird,ShowAnswerFnThird]=useState(false);
    const [ShowAnswerFourth,ShowAnswerFnFourth]=useState(false);
    let Answer="You can go through our booking page, choose your desired ticket and go ahead!";
    let AnswerSecond="You can fetch through the website and book your ticket";
    let AnswerThird="We're aware of the importance of well qualified support, that is why we decided that support will only be provided by the authors that actually worked on this project.";
    let AnswerFourth="You can use Windster for an unlimited amount of projects, whether it's a personal website, a SaaS app, or a website for a client. As long as you don't build a product that will directly compete with Windster either as a UI kit, theme, or template, it's fine."
    if(!ShowAnswer){
    Answer="";
    }
    if(!ShowAnswerSecond){
        ...
        <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
            <div>
                <div className="mb-10">
                    ...
                    <button class="bg-black hover:bg-black text-white font-bold py-2 px-4 border border-black rounded" onClick={()=>ShowAnswerFn(!ShowAnswer)}>
                         Show Answer
                   </button>
                ...
                <div className="mb-10">                        
                    ...
                    <button class="bg-black hover:bg-black text-white font-bold py-2 px-4 border border-black rounded" onClick={()=>ShowAnswerFnSecond(!ShowAnswerSecond)}>
                         Show Answer
                   </button>
  
                    <p className="text-gray-500 dark:text-gray-400">{AnswerSecond}</p>
                </div>
                <div className="mb-10">
                    <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                        <svg className="flex-shrink-0 mr-2 w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg>
                    ...
                    <button class="bg-black hover:bg-black text-white font-bold py-2 px-4 border border-black rounded" onClick={()=>ShowAnswerFnThird(!AnswerThird)}>
                         Show Answer
                   </button>
                    <p className="text-gray-500 dark:text-gray-400">{AnswerThird}</p>
                ...
                <div className="mb-10">
                    ...
                    <button class="bg-black hover:bg-black text-white font-bold py-2 px-4 border border-black rounded" onClick={()=>ShowAnswerFnFourth(!ShowAnswerFourth)}>
                         Show Answer
                   </button>
                    <p className="text-gray-500 dark:text-gray-400">{AnswerFourth}</p>
            ...
            <div>
                <div className="mb-10">
                    ...
                    <button class="bg-black hover:bg-black text-white font-bold py-2 px-4 border border-black rounded">
                         Show Answer
                   </button>
